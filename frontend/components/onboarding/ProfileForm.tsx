    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="number" {...register("current_age")}
        ...
        <div>
          ...
          <input type="number" {...register("retirement_age")}
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="number" {...register("annual_income")}
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        ...
        <div>
          ...
          <input type="number" step="0.01" {...register("income_growth_rate")}
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="number" {...register("annual_expenses")}
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Current Portfolio ($)</label>
          <input type="number" {...register("current_portfolio_value")}
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="number" {...register("annual_contribution")}
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">State (2-letter)</label>
          <input type="text" maxLength={2} {...register("state")}
